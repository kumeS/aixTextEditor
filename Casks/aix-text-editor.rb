# Homebrew Cask for AIX Text Editor.
#
...
#   3. Compute its checksum:    shasum -a 256 "AIX Text Editor_<version>_aarch64.dmg"
...
cask "aix-text-editor" do
  ...
  url "https://github.com/kumeS/AIX_Text_Editor/releases/download/v#{version}/AIX.Text.Editor_#{version}_aarch64.dmg"
  name "AIX Text Editor"
  desc "LLM-augmented, chunk-based editor for academic papers and reports"
  homepage "https://github.com/kumeS/AIX_Text_Editor"

  depends_on macos: ">= :big_sur"

  app "AIX Text Editor.app"
